...
const SAMPLE_PRODUCTS = [
  {
    name: 'Scene Report Tee',
    slug: 'scene-report-tee',
    description: "The official uniform of people who always know what's happening.",
    category: 'PRINTED_TSHIRT' as const,
    tags: ['pop-culture', 'scene report', 'indian internet', 'Indian culture', 'heavyweight'],
    basePrice: 1199,
    comparePrice: 1499,
  ...
  {
    name: 'Indian Lore Oversized Tee',
    slug: 'indian-lore-oversized-tee',
    description: "Some things don't need explanation.",
    category: 'OVERSIZED_TEE' as const,
    tags: ['couple', 'indian lore', 'oversized', 'drop-shoulder', 'streetwear'],
    basePrice: 1399,
    comparePrice: null,
  ...
  {
    name: 'Cinema Mode Hoodie',
    slug: 'cinema-mode-hoodie',
    description: 'For people whose internal monologue has background music.',
    category: 'HOODIE' as const,
    tags: ['pop-culture', 'cinema mode', 'hoodie', 'heavyweight', 'cinema'],
    basePrice: 1899,
    comparePrice: 2199,
  ...
  },
  {
    ...
    tags: ['comic', 'fix system', 'clever fixes', 'cap', 'accessories'],
    basePrice: 999,
    comparePrice: null,
  ...
  {
    name: 'Ambition Pending Crewneck',
    slug: 'ambition-pending-crewneck',
    description: 'Rich in potential. Financially loading.',
    category: 'SWEATSHIRT' as const,
    tags: ['pop-culture', 'ambition pending', 'luxury loading', 'crewneck', 'sweatshirt'],
    basePrice: 1599,
    comparePrice: null,
  ...
  {
    name: 'Plot Twist Loading Tee',
    slug: 'plot-twist-loading-tee',
    description: 'Modern Indian internet behaviour, printed on heavyweight cotton.',
    category: 'PRINTED_TSHIRT' as const,
    tags: ['comic', 'plot twist', 'scene report', 'printed tee', 'indian internet'],
    basePrice: 1099,
    comparePrice: 1299,
