  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="display-heading text-3xl md:text-4xl mb-4">Small Plot Twist Detected.</h1>
        <p className="text-smoke mb-8 text-sm leading-relaxed">
          Something broke for a second. Try again, or contact support if the issue continues.
        </p>
        {error.digest && (
