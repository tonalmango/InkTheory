    ...
    <section className="bg-cream py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[0.95fr_1.05fr] gap-8 lg:gap-12 items-stretch">
          <motion.div
            className="relative min-h-[420px] lg:min-h-[560px] overflow-hidden bg-ink border-2 border-saffron/30"
          ...
          <motion.div
            className="bg-ink text-cream p-8 sm:p-10 md:p-14 flex flex-col justify-between min-h-[420px] relative overflow-hidden border-l-4 border-saffron"
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
